      ...
      wireframes: [
        {
          title: "Cover",
          label: "01 — Overview",
          image: "/case-studies/xiphias-immigration/wf-cover.png",
          caption: "Wireframes mapped the structure of a live 55-route platform. Annotations mark observations (blue), friction points (orange), and proposed changes (green).",
          span: "full", imgW: 1400, imgH: 357,
        },
        {
          title: "Information Architecture — Sitemap",
          label: "02 — Sitemap",
          image: "/case-studies/xiphias-immigration/wf-sitemap.png",
          caption: "5 top-level pillars replacing a flat country directory: Programmes (4 tracks × 45 countries), Tools, Content, Company, Convert.",
          span: "half", imgW: 1400, imgH: 409,
        },
        {
          title: "User Flows — 4 Journey Types",
          label: "03 — User Flows",
          image: "/case-studies/xiphias-immigration/wf-user-flows.png",
          caption: "Ready to act → Exploring → Researching → Referred. Each journey maps to a different entry point and conversion strategy.",
          span: "half", imgW: 1400, imgH: 480,
        },
        {
          title: "Homepage — Current Structure",
          label: "04 — Before",
          image: "/case-studies/xiphias-immigration/wf-home-current.png",
          caption: "9 disconnected blocks — Hero, 4 separate programme previews, XIA Intelligence, FAQ, Advisor card, News, Footer. No unified explorer.",
          span: "half", imgW: 1000, imgH: 1359,
        },
        {
          title: "Homepage — Proposed Structure",
          label: "05 — After",
          image: "/case-studies/xiphias-immigration/wf-home-proposed.png",
          caption: "Unified explorer with track tabs, Tools strip, single conversion block. Fewer sections, higher intent clarity.",
          span: "half", imgW: 1000, imgH: 1012,
        },
        {
          title: "Residency Track — Page Structure",
          label: "06 — Programme Page",
          image: "/case-studies/xiphias-immigration/wf-residency.png",
          caption: "Hero + CTA, 2-col country grid (20 cards) with sticky sidebar, trust → news → footer. All entries powered from a single JSON data model.",
          span: "full", imgW: 1200, imgH: 1093,
        },
        {
          title: "Booking Flow — 4 Steps",
          label: "07 — Booking",
          image: "/case-studies/xiphias-immigration/wf-booking.png",
          caption: "Choose → Details → Pay → Confirm. Step 4 was missing from the live site; adding booking summary + calendar invite reduced post-booking support calls.",
          span: "half", imgW: 1400, imgH: 406,
        },
        {
          title: "Eligibility Wizard — 4 Steps",
          label: "08 — Eligibility Wizard",
          image: "/case-studies/xiphias-immigration/wf-eligibility.png",
          caption: "Profile → Goals → Finances → Results. Self-serve qualification before any advisor interaction — improving lead quality.",
          span: "half", imgW: 1400, imgH: 324,
        },
      ],
